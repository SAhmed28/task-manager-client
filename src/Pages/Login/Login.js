        ...
        <div className='w-[450px] mx-auto shadow-xl p-7 my-4'>
            ...
            <form onSubmit={handleSubmit(handleLogin)}>
                ...
                <div className="mb-4">
                    ...
                    <div className="mt-2">
                        <label className="form-label inline-block mb-2 text-indigo-600 text-sm">
            ...
            <p className='text-center'>New to Task Manager? <Link to='/signup' className='text-indigo-600'>Create new account</Link></p>
