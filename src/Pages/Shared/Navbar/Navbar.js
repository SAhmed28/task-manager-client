...
const Navbar = () => {
    const menuItems =
        <React.Fragment>
            ...
            <li>
                <Link to="/addtask" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">Add Task</Link>
            </li>
            <li>
                <Link to="/mytask" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">My Task</Link>
            </li>
            <li>
                <Link to="/completedtask" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">Completed Task</Link>
            </li>
        </React.Fragment>
        ...
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded ">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <Link to="/" className="flex items-center">
                    <TfiList className="text-indigo-600 mr-4 border-2 border-indigo-600 rounded-full h-10 w-10 p-2"/>
